      ...
      <div class="flex justify-center ml-10">
        ...
        <div class="mt-2">
          <select
            id="entries"
            name="entries"
            class="w-16 rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
          >
            <option>5</option>
            <option>10</option>
            <option>15</option>
      ...
      <table class="w-full table-auto border-2 border-slate-400 rounded mt-10">
        <thead>
          <tr class="border-2 border-slate-400">
            ...
            <th
              class="px-4 py-2 border border-gray-200 text-center flex justify-center"
            >
              Tanggal Keluar
              <button>
                <svg
        ...
        <tbody class="border-2 border-slate-400">
          <tr>
            ...
            <td class="px-4 py-2 border border-gray-300 text-center">
              <button
                class="rounded-lg text-sm py-2 px-3 mr-1 bg-red-700 text-white hover:bg-red-900"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <router-link to="/barang-keluar/detail">
                <button
                  class="rounded-lg text-sm py-2 px-3 bg-amber-400 text-white hover:bg-amber-500"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
          ...
          <tr>
            <td class="px-4 py-2 border border-gray-300 text-center">5</td>
            <td class="px-4 py-2 border border-gray-300 text-center">
              TK-0004
            </td>
            <td class="px-4 py-2 border border-gray-300 text-center">
